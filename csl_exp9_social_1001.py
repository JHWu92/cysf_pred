...
def load_data():
    ...
    ys = {}
    for fn in glob.glob('data/exp9_ys/1001/*'):
...
def exp9_one_run(exp_path, Xs, y, train_idx, test_idx):
    def upsampling():
...
def exp9(Xs, y, qa):
    for seed in SEEDS:
        ...
        exp_path = 'experiment_1001/exp9_social/%s/seed_%d' % (qa, seed)
        ...
        exp9_one_run(exp_path, Xs, y, train_idx, test_idx)
        # break  # run one seed
