...
def baseline_majority_vote(single_pred, test_y, exp_path):
    ...
    res = {'model'           : 'majority_vote',
           ...
           'test_precision_weighted': precision_score(test_y.round(), pred, average='weighted'),
           'test_precision_micro'   : precision_score(test_y.round(), pred, average='micro'),
           'test_precision_macro'   : precision_score(test_y.round(), pred, average='macro'),
           'test_recall_weighted': recall_score(test_y.round(), pred, average='weighted'),
           'test_recall_micro'   : recall_score(test_y.round(), pred, average='micro'),
           'test_recall_macro'   : recall_score(test_y.round(), pred, average='macro')}
...
if __name__ == '__main__':
    CSL_FN = 'data/y_csl_all-2017-10-01.csv'
    main()
